...
export function StatisticsCard({ color, icon, title, value, footer }) {
  return (
    <Card className="shadow-lg shadow-gray-500/40 border-0 bg-white drop-shadow-lg">
      <CardBody className="p-[1.25rem] sm:p-[1.5rem] md:p-[1.75rem] text-left flex items-start gap-5">
      ...
      {footer && (
        <CardFooter className="p-[1.25rem] sm:p-[1.5rem] md:p-[1.75rem] bg-gray-50/30">
          {footer}
        </CardFooter>
      )}
    </Card>
